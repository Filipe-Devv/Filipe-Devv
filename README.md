...
### 🚀 Sobre Mim
- 📚 Atualmente aprofundando conhecimentos em **Python**, **Lógica de Programação** e **Banco de Dados (SQL)**.
- 🛠️ Trabalhando em projetos práticos e exercícios de desenvolvimento de sistemas.
- 🎯 Objetivos: Desenvolver minhas habilidades como programador e criar projetos incríveis.
